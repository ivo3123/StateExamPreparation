...
Нека функцията $f$ е $n+1$ пъти диференцируема в отворен интервал, съдържащ точката $x_0$. Нека $x$ е от интервала. Тогава съществува точка $c$, такава че остатъчният член $R_n(x)$ има вида:
