...
### ДИ, септември 2025, за СИ и КН и И и ИС

$$\displaystyle \int \limits_{0}^{1} x\arctan{x}\space dx$$

### ДИ, юли 2025, за СИ и КН и И и ИС

$$\displaystyle \int \limits_{0}^{1} x^5 \ln{(x^4 + 1)}\space dx$$
...
### ДИ, юли 2025, за ПМ и М и Стат

$$\displaystyle \int \limits_{0}^{2} \dfrac{1}{x^2 + 4} \space dx$$

### ДИ, септември 2024, за Стат

$$\displaystyle \int \limits_{0}^{1} \arctan{\left(\frac{1}{x}\right)} \space dx$$
